...
class TestListFiles:
    def test_when_same_extension(self, tmp_path):
        ...
        expected = [a_fn, b_fn]
        actual = dataset.list_files(my_folder_dir, '.jpg')
        assert dataset.lists_have_same_elements(expected, actual)
    ...
    def test_not_lexicographic(self, tmp_path):
        ...
        actual = dataset.list_files(my_folder_dir, '.jpg', sort_ascending=False)
        assert dataset.lists_have_same_elements(expected, actual)
...
class TestListSubdirFiles:
    def test_naive(self, tmp_path):
        ...
        actual = dataset.list_subdir_files(original_frames_dir, '.jpg')
        assert dataset.lists_have_same_elements(expected, actual)
